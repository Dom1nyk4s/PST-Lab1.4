...
public class Main {
   ...
   public static void register(){
      ...
      driver.findElement(By.xpath("//input[@id=\"FirstName\" and @class=\"text-box single-line\"]")).sendKeys(Main.firstname);
      driver.findElement(By.xpath("//input[@id=\"LastName\" and @class=\"text-box single-line\"]")).sendKeys(Main.lastname);
      ...
      driver.findElement(By.xpath("//input[@id=\"Password\"]")).sendKeys(Main.password);
      driver.findElement(By.xpath("//input[@id=\"ConfirmPassword\"]")).sendKeys(Main.password);
   ...
   public void test1(String fileName) {
      ...
      try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
         ...
         while ((line = br.readLine()) != null) {
            ...
            wait.until(d -> driver.findElement(By.xpath("//div[@class=\"ajax-loading-block-window\"]")).getAttribute("style").trim().equals("display: none;"));
            driver.findElement(By.xpath("(//input[@value=\"Add to cart\"])[ancestor::div[@class=\"details\"]/h2[@class=\"product-title\"]/a[contains(text(), '" + line + "')]]")).click();
      ...
      if (driver.findElement(By.xpath("//div[@class='section new-billing-address']")).getAttribute("style").trim().equals("display: none;")){
      ...
      //driver.findElement(By.xpath("//input[@value=\"Continue\" and @class=\"button-1 shipping-method-next-step-button\"]")).click();
      ...
      String titleMessage = driver.findElement(By.xpath("//div[@class=\"section order-completed\"]/div[@class=\"title\"]/strong")).getText();
   ...
   public void test2() {
      ...
      try (BufferedReader br = new BufferedReader(new FileReader(test2fileName))) {
         String line;
         while ((line = br.readLine()) != null) {
